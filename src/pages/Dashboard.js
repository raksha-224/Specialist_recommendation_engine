...
const Dashboard = () => {
  ...
  const handleCheckSymptoms = () => {
    navigate('/predict');  // Always navigate to predict page
  };
  ...
  return (
    <div style={{ 
      ...
      minHeight: 'calc(100vh - 60px)' // Reduced to account for header only
    }}>
      <h1 style={{ 
        fontSize: '2.2rem', 
        fontWeight: 'bold',
      ...
      {hasSubmittedForm && (
        <div style={{
          ...
          borderRadius: '15px',
          padding: '15px 20px',
          marginBottom: '5px', // Reduced margin before footer
          boxShadow: '0 2px 15px rgba(0,0,0,0.05)',
          position: 'relative',
          overflow: 'hidden',
          textAlign: 'center'
